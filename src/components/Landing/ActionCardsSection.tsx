...
const ActionCard = ({ icon, title, delay, variant }: ActionCardProps) => {
  ...
  return (
    ...
    >
      <div
        className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 icon-hover"
...
export function ActionCardsSection() {
  ...
  return (
    <section ref={ref} className="premium-overlap-section relative z-30 -mt-6 md:-mt-12 py-16 md:py-24 lg:py-28 section-alt overflow-hidden" data-testid="action-cards-section">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-500 mb-4 tracking-tight">
            {t('landing.actionCards.title', 'Automate Tasks & Actions')}
          </h2>
