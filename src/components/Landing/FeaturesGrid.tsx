...
export function FeaturesGrid() {
  return (
    <section 
      id="features" 
      className="premium-overlap-section relative z-10 -mt-6 md:-mt-12 py-12 sm:py-16 md:py-24 lg:py-32 overflow-hidden"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {features.map((feature, index) => (
            ...
            >
              <Card className="p-4 sm:p-6 md:p-8 premium-card-3d rounded-3xl bg-white border border-orange-100 shadow-sm hover:shadow-xl transition-all duration-300 h-full group">
                <motion.div 
                  className={`h-12 w-12 sm:h-14 sm:w-14 rounded-xl bg-gradient-to-br ${feature.iconColor} flex items-center justify-center mb-4 sm:mb-6 shadow-lg ${feature.shadowColor} icon-hover`}
