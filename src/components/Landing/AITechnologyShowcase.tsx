...
export function AITechnologyShowcase() {
  return (
    <section 
      className="premium-overlap-section relative z-50 -mt-6 md:-mt-12 py-12 sm:py-16 md:py-24 lg:py-32 overflow-hidden"
      data-testid="section-ai-technology"
    >
      <div className="absolute inset-0 bg-[#f6f6ef]" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {technologies.map((item, index) => (
            ...
            >
              <Card className="p-4 sm:p-6 md:p-8 premium-card-3d rounded-2xl md:rounded-3xl hover-elevate transition-all h-full group relative overflow-hidden">
