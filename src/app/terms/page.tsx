...
export const metadata: Metadata = {
  title: { absolute: "Terms of Service — RevoAI" },
  description: "Terms and conditions for using the RevoAI AI voice agent platform.",
  alternates: { canonical: "https://revoai.co/terms" },
  openGraph: { title: "Terms of Service — RevoAI", description: "Terms and conditions for using the RevoAI AI voice agent platform.", url: "https://revoai.co/terms" },
  twitter: { title: "Terms of Service — RevoAI", description: "Terms and conditions for using the RevoAI AI voice agent platform." },
};
